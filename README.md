...
## Описание
В строке ``https://youtu.be/5lwH4APNOuo?t=216`` преобразует число ``216`` в человеческие ``3 минуты и 36 секунд``

Вдохновился после просмотра вот [этого](https://youtu.be/Gmt3Nk9KoMc) видеоролика.

Решил сделать свой проект, чтоб более быстро и удобно нарезать видео на главы в полуавтоматическом режиме.
...
## Использование
### Вариант через __буфер обмена__ - main.py
...
### Вариант через регулярные выражения, __чтение запись файла__ - description.py
